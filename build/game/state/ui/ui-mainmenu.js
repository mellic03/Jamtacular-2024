...
export class GS_MainMenuGUI extends GameState {
    constructor() {
        ...
        this.ui = new ui_List(new ui_Title("Main"), new ui_Button("Continue", () => { GameStateUserInput.emit(UserInputMsg.UNPAUSE); }), new ui_Button("Region 1", () => { transition(GS_World, GS_Region1); }), new ui_Button("Region 2", () => { transition(GS_World, GS_Region2); }), new ui_Button("Region 3", () => { transition(GS_World, GS_Region3); }), new ui_Button("Editor", () => { transition(GS_Editor, GS_EditorTest); }), new ui_Button("Settings", () => { this.parent.pushState(GS_SettingsGUI); }), new ui_Button("Exit"));
...
//# sourceMappingURL=ui-mainmenu.js.map