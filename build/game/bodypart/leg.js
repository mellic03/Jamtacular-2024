...
export class LegParams {
    constructor(foot_xoffset = 0, foot_maxdist = 80, step_overshoot = 0.25, step_duration = 0.15, step_height = 32, rest_height = 0.95) {
...
export default class BodyPartLeg extends BodyPart {
    constructor(x, y, dists, alpha_offset = 0) {
        super(x, y);
        ...
        this.curr_foot = new vec2(0, 0);
        this.next_foot = new vec2(0, 0);
        this.other = null;
    ...
    draw() {
        ...
        for (let i = 0; i < this.joints.length - 1; i++) {
            ...
            sys_Render.imageRotated(img, 0, -8, dist, 16, A, B);
        }
        strokeWeight(1);
    }
}
