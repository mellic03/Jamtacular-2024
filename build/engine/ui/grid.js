...
export default class ui_Grid extends ui_ElementBase {
    constructor(rows, cols, ...children) {
        ...
        this.row_ratios = new Array();
        this.col_ratios = new Array();
        this.rows = rows;
        this.cols = cols;
        this.temp = new ui_Bounds(0, 0, 1024, 1024);
        this.row_ratios = new idk_vector(rows, 1.0 / rows);
        this.col_ratios = new idk_vector(cols, 1.0 / cols);
    }
    update(bounds) {
        super.update(bounds);
