...
export class ui_ValueRef {
    constructor(value) {
        this.value = value;
    }
}
function default_dec(vref) { vref.value -= 1; }
function default_inc(vref) { vref.value += 1; }
export default class ui_PMinus extends ui_Grid {
     ...
     */
    constructor(label, valueRef, dec = default_dec, inc = default_inc) {
        ...
        super(1, 3, A, new TestButton("-", () => { dec(this.vref); }), new TestButton("+", () => { inc(this.vref); }));
...
//# sourceMappingURL=pminus.js.map