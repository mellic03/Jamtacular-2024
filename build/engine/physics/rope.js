...
export default class Rope {
    constructor(x, y, ropegroup, count, length = 32, mass = 1.0, drag = 0.1, friction = 0.02, thickness = 8, grav = 0.02, lengthFactor = 1, massFactor = 1, dragFactor = 1, frictionFactor = 1, thicknessFactor = 1, gravFactor = 1) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            B.sprite.drag = drag;
            drag *= dragFactor;
            B.sprite.gravityScale = grav;
            grav *= gravFactor;
            B.sprite.friction = friction;
