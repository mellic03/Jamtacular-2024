...
import { WorldGridSector } from "../worldgrid.js";
import vec2 from "../math/vec2.js";

export default class RenderEngine
{
    private offline_ctx: any;
    ...
    constructor( w: number, h: number, webgl: boolean = false )
    {
        this.width   = w;
        this.height  = h;
        this.webgl   = webgl;
    ...
    private _renderWorldGridSector( cam: idk_Camera, sector: WorldGridSector )
    {
    ...
    renderWorldGridSector( cam: idk_Camera, sector: WorldGridSector )
    {
        push();
